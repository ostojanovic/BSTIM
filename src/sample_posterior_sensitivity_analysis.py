...
prior_scale, model_complexity, disease = sensitivity_analysis_combinations[i]
...
filename_params = "/data/BSTIM/data/sensitivity_analysis/mcmc_samples/parameters_{}_{}_{}_{:0.3}".format(disease, use_age, use_eastwest, prior_scale)
filename_pred = "/data/BSTIM/data/sensitivity_analysis/mcmc_samples/predictions_{}_{}_{}_{:0.3}.pkl".format(disease, use_age, use_eastwest, prior_scale)
filename_model = "/data/BSTIM/data/sensitivity_analysis/mcmc_samples/model_{}_{}_{}_{:0.3}.pkl".format(disease, use_age, use_eastwest, prior_scale)
...
model = BaseModel(tspan, county_info, ["../data/ia_effect_samples/{}_{}.pkl".format(disease, i) for i in range(100)], prior_scale=prior_scale, include_eastwest=use_eastwest, include_demographics=use_age)
